...
随意使用, 否则, 可能得不到你想要的结果. 关于具体的含义, 有空再写.

\section{生成文档}
当你写完你的文档的时候, 你就可以通过 \texttt{xelatex} 程序来编译生成 pdf 文档了.
...
不管用何种方式联系我, 请在邮件标题或者是 QQ 验证信息里加入 ``CUGTeX模板问题'' 的字样.
